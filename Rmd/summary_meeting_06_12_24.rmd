...
fig1 <- fig1 %>% layout(
    title = paste0("nCell = 1 - Total size = ", size1, " MiB"),
...
fig16 <- fig16 %>% layout(
    title = paste0("nCell = 16 - Total size = ", size16, " MiB"),
    xaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE),
    yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE)
)
fig16
...
fig32 <- fig32 %>% layout(
    title = paste0("nCell = 32 - Total size = ", size32, " MiB"),
    xaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE),
    yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE)
)
fig32
...
Object size 4000:
  - Total: 7.7 GB
  - colData 1041360 bytes
  - assay 3743666144
  - rowData 2914365904
  
  - peptide : 90979 rows and 3996 columns
  - peptides: 2954189576 bytes => 2.8 GB
  - proteins: 0.4 GB
  
  => problem with the peptide assay
## Peak RAM by step
```{r heatMapRAM}
